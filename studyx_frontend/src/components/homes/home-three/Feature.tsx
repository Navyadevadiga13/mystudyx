...
const feature_data: DataType[] = [
   {
      id: 1,
      icon: "assets/img/icon/fetaure-iocon1.png",
      title: "Model Explainability & Audit Logs"
   },
   {
      id: 2,
      icon: "assets/img/icon/fetaure-iocon2.png",
      title: "Drag & Drop Workflow Builder"
   },
   {
      id: 3,
      icon: "assets/img/icon/fetaure-iocon3.png",
      title: "Real-Time Dashboards"
   },
   {
      id: 4,
      icon: "assets/img/icon/fetaure-iocon4.png",
...
const Feature = () => {
   return (
      <section className="feature-section position-relative pb-100 z-1 pt-100">
         <div className="container">
            <div className="row g-4 justify-content-between">
               <div className="col-lg-6">
                  <div className="section-title mb-4 pb-lg-3">
                     <span
                     ...
                     <h2 className="black-clr mb-3 fw-bold wow fadeInUp" data-wow-delay=".3s">
                        Streamline Your Business with Powerful AI Tools!
                     </h2>
                     <p className="black-clr">
                        Our platform offers a powerful suite of AI/ML tools to simplify and enhance your machine
                        learning processes
                     </p>
                  </div>
                  <div className="row g-3">
                     {feature_data.map((item) => (
                        <div key={item.id} className="col-sm-6">
                           <div className="feature-sub-item d-flex gap-3 align-items-center">
               ...
               <div className="col-lg-6">
                  <div className="feature-thumb ps-lg-5 img-custom-anim-right">
                     <img src="/assets/img/about/feature-thumb.png" alt="img" className="w-100" />
                  </div>
               </div>
            </div>
         </div>
         <img src="/assets/img/element/feature-bg.png" alt="img"
            className="feature-bg position-absolute top-0 start-0 w-100 z-n1" />
      </section>
   )
}
