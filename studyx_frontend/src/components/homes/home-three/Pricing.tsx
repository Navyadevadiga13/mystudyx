...
const Pricing = () => {
   return (
      <section className="pricing-section3 position-relative z-1 pt-100 pb-100">
         <img src="/assets/img/element/pricing-bg3.png" alt="img" className="pricing-bg3" />
         <div className="container pt-xl-5">
            <div className="row g-4">
               {pricing_data.map((item) => (
                  <div key={item.id} className="col-md-6 col-lg-4">
                     <div className={`pricing-plan-items pricing-plan-items3 rounded-4 wow fadeInUp ${item.active}`} data-wow-delay=".2s">
