...
const Choose = () => {
   return (
      <section className="choose4-section section-bg ">
                  ...
                  <div className="col-lg-7 col-md-7">
                     <div className="section-header">
                        <div className="d-flex align-items-center gap-2 theme-clr fw-600 mb-lg-3 m-2">
                           <img src="/assets/img/icon/section-step1.png" alt="img" /> Our Approach
                        </div>
                        <h2 className="theme-clr4 fw-bold wow fadeInUp" data-wow-delay=".3s">
                           Launching Your Business
                           <span className="fw-300">Safely, Strategically, and Successfully</span>
                        </h2>
                     </div>
                  </div>
                  <div className="col-lg-5 col-md-5">
                     <div className="wow fadeInUp" data-wow-delay=".4s">
                        <p className="theme-clr4">
                           Our approach to wealth planning goes beyond just investing. It’s about understanding your financial goals, values, and
                           lifestyle needs. We then create a customized strategy that grows your wealth, minimizes risks, and prepares you for the
                           future.
                        </p>
                     </div>
                  </div>
               ...
               <div className="row g-4">
                  {work_data.map((item) => (
                     <div key={item.id} className="col-sm-6 col-lg-4 col-xl-3">
                        <div className="service-items2 approch-items section-bg rounded-4 z-1 position-relative">
                           <img src="/assets/img/logo/hover-ele.png" alt="img" className="hover-ele position-absolute bottom-0 z-n1" />
                           <div className="content">
                              <div className="mb-lg-5 mb-4 d-center rounded-circle icons">
                                 {item.icon}
                              </div>
                              <h4 className="mb-sm-3 mb-2 wow fadeInUp" data-wow-delay=".3s">
                                 <Link to="/services-details" className="theme-clr4 fw-700 lh-110 fw-600">
                                    {item.title}
                                 </Link>
                              </h4>
